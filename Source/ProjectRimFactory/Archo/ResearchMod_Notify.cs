...
namespace ProjectRimFactory.Archo
{
    public class ResearchMod_Notify : ResearchMod
    {
        ...
        {
            if (Find.WindowStack.WindowOfType<Dialog_MessageBox>() == null && !Current.Game.World
                .GetComponent<WorldComponent_NotificatonManager>().notifiedMessages.Contains(text))
            {
