...
{
    public interface IBeltConveyorLinkable : IPRF_Building, ILoadReferenceable
    {
        /// <summary>
        ///     Is the conveyor "stuck" - with an item it cannot place
        /// </summary>
        /// <value>
        ///     <c>true</c> if it cannot place the item it has;
        ///     <c>false</c> if it has free space for an item.
        /// </value>
        bool IsStuck { get; }
        ...
        ///     If set to <c>false</c>, assume position is valid,
        ///     and only check other considerations - probably only used internally.
        /// </param>
